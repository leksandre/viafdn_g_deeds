...
extension ViewController: WKUIDelegate {
    ...
    func webView(_ webView: WKWebView, decidePolicyFor navigationAction: WKNavigationAction, decisionHandler: @escaping (WKNavigationActionPolicy) -> Void) {
        ...
        if let requestUrl = navigationAction.request.url{
                ...
                if (matchingHostOrigin != nil) {
                    ...
                    if (matchingAuthOrigin != nil) {
                        ...
                        if (navigationAction.navigationType == .other &&
                            ...
                            if let url = URL(string: requestUrl.absoluteString.addingPercentEncoding(withAllowedCharacters: .urlHostAllowed)!), UIApplication.shared.canOpenURL(url) {    UIApplication.shared.open(url)
                            }
                            
                            if let url = URL(string: requestUrl.absoluteString), UIApplication.shared.canOpenURL(url) {
            ...
            UIApplication.shared.open(navigationAction.request.url!.absoluteURL)
